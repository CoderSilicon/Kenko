...
export default function ResultsDisplay({
  ...
  return (
    <div className="w-full animate-in slide-up duration-600">
      {/* Reset */}
      <div className="no-print w-full border-b border-[#e8e4df] bg-[#f0ece6] px-8 py-4 md:px-16">
        <button
          type="button"
          onClick={onReset}
      ...
      {/* Continue with Kenko */}
      <div className="no-print w-full px-8 py-12 md:px-16">
        <div className="mx-auto max-w-3xl">
          <p className="mb-6 text-center text-[10px] font-medium tracking-[0.3em] text-[#b8b0a6] uppercase">
            Next Steps
          </p>
          <div className="grid gap-4 md:grid-cols-2">
            <button
              ...
              className="group flex items-start gap-4 border border-[#d4c8bc] bg-[#faf8f5] p-6 text-left transition-colors hover:border-[#8a8278]"
            >
              <span className="text-[10px] font-medium tracking-wider text-[#b8b0a6]">
                01
              </span>
              <span>
                ...
                <span className="mt-1 block text-xs font-light leading-relaxed text-[#8a8278]">
                  A structured summary of your evaluation, timeline, and
                  questions — ready to bring to a clinician.
                </span>
              </span>
            </button>
            <button
            ...
            >
              ...
              <span>
                ...
                <span className="mt-1 block text-xs font-light leading-relaxed text-[#8a8278]">
                  Check in daily and watch how your symptoms trend over time.
                </span>
              </span>
            </button>
          </div>
      ...
      {/* Disclaimer */}
      <div className="no-print w-full bg-[#f5f0eb] px-8 py-8 md:px-16">
